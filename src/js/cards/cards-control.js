                    ...
                    window.app.openModalSelect(`Editar Cartão Digital - ${card['name']}(${card['jobtitle']})`, [
                        ...
                        document.getElementById('button-upload-photo').onclick = async function () {
                            ...
                            if (input && input.files.length > 0) {
                                ...
                                window.app.fileUpload(input.files, 'assets/perfil', { type: 'temporary', index: `page-card-create-input-upload-photo-user`, origin: internetadress })
                                    .then(data => {
                                        $('#input-photo')
                                            .attr('disabled', false)
                                            .val('');
                        ...
                        document.getElementById('button-upload-file').onclick = async function () {
                            ...
                            if (input && input.files.length > 0) {
                                ...
                                window.app.fileUpload(input.files, 'assets/Apresentação', { type: 'temporary', index: `page-card-create-input-upload-file-user`, origin: internetadress })
                                    .then(data => {
                                        $('#input-file')
                                            .attr('disabled', false)
                                            .val('');
